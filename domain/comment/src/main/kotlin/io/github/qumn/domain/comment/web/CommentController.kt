...
class CommentController(
    ...
    @PutMapping("{cid}/like")
    fun likeCommand(@PathVariable("cid") cid: CommentId): Rsp<Unit> {
    ...
    fun unlikeCommand(@PathVariable("cid") cid: CommentId): Rsp<Unit> {
        val uid = LoginUser.current.uid
    ...
    fun replay(@PathVariable("cid") cid: CommentId, @RequestBody replayReq: ReplayReq) {
        val uid = LoginUser.current.uid
